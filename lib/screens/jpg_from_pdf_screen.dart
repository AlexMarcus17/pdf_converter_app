...
class JpgFromPdfScreen extends StatefulWidget {
  final String pdfPath;
  final String originalName;

  const JpgFromPdfScreen({
    super.key,
  ...
  @override
  State<JpgFromPdfScreen> createState() => _JpgFromPdfScreenState();
}

class _JpgFromPdfScreenState extends State<JpgFromPdfScreen> {
  ...
  Future<void> _generateImages() async {
    ...
    try {
      final images = await _pdfService.extractJpegFromPdf(widget.pdfPath);
      setState(() {
      ...
      for (var image in images) {
        _pdfService.addJpgsToHistory(
            [File(image)], '${widget.originalName}_$index.jpg');
        index++;
      }
    } catch (e) {
      setState(() {
